    ...
    async def on_submit(self, interaction: discord.Interaction) -> None:
        ...
        if channel:
            if channel.permissions_for(self.view.ctx.me).send_messages:
                ...
                await channel.send(embed=self.view.embed,view=ticket_launcher())
                embed = discord.Embed(
                    title="Sent Embed",
...
class TicketEmbedBaseModal(discord.ui.Modal):
    """
...
class TicketEmbedView(discord.ui.View):
 ...
 #       await interaction.response.send_message(embed=embed, file=file)
    ...
    async def base_button(
        ...
        Edit the base
        """
        await interaction.response.send_modal(TicketEmbedBaseModal(self))
    ...
    async def complete_button(
        ...
        Complete the embed
        """
        await interaction.response.edit_message(embed=self.embed, view=ticket_launcher())
        self.completed = True
        self.stop()
