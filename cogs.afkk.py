...
from cogs._anuke import Afkviewp
...
class OnOrOff(BasicView):
    ...
    @discord.ui.button( emoji="<:Pepe_yes:1123674245285826650>", custom_id='Yes', style=discord.ButtonStyle.green)
    ...
    @discord.ui.button(emoji="<:pepe_no:1123674247856926790>", custom_id='No', style=discord.ButtonStyle.danger)
...
class afkas(commands.Cog):
        ...
        if message.mentions:
            ...
            for user_mention in message.mentions:
                ...
                if afk[f'{user_mention.id}']['AFK'] == 'True':
                    ...
                    await message.channel.send(f'**{str(user_mention)}** went AFK <t:{ok}:R> : **{reason}**',allowed_mentions=discord.AllowedMentions(
            ...
            users=False))
                    ...
                    ok = Button(label="Jump To Message",style=discord.ButtonStyle.link,url=message.jump_url)
                    ...
                    await user_mention.send(embed=embed,view=view)
                ...
                if afk[f'{message.author.id}']['AFK'] == 'True':
                    ...
                    await message.channel.send(f'Welcome Back {str(message.author.mention)} |  i removed your afk, You were afk for **{been_afk_for}**, You were mentioned **{mentionz}** times')
                   ...
                   # await message.channel.send(embed=wlba)
                    ...
                    if afk[f'{user_mention.id}']['AFK'] == 'True':
                        ...
                        await message.channel.send(f'**{str(user_mention)}** went AFK <t:{ok}:R> : {reason}')
    ...
    async def test24(self, ctx, *, reason=None):
        ...
        if 'discord.gg' in reason:
            ...
            emd = discord.Embed(description="You can't Advertise in Afk Reason", color=0x2f3136)
        ...
        if "<&@" in reason:
            ...
            embd = discord.Embed(description="You can't use role in Afk Reason", color=0x2f3136)
        ...
        if '.gg/' in reason:
            ...
            eme = discord.Embed(description="You can't Advertise in Afk Reason", color=0x2f3136)
        ...
        em = discord.Embed(description="** Click on yes button to get every mention in dm**", color=0x2f3136)
        ...
        if not view.value:
            ...
            return await test.edit(content="Time Out!", view=None)
        ...
        await ctx.send(f'{ctx.author.mention} Your AFK is now set to: **{reason}**')
...
async def setup(client):
  ...
  await client.add_cog(afkas(client))
