...
async def do_rtfm(self, interaction, key, obj):
	...
	if obj is None and key == 'latest':
		...
		e = discord.Embed(title="__**Discord.py Documentation Lookup**__", description='[Click to View the Discord.py Documentation](<https://discordpy.readthedocs.io/en/latest>)\nYou may also search for a Reference Point in the Documentation.\n`rtd <Reference Query>`', colour=discord.Colour.blurple(),  timestamp=datetime.now(), color=0xac5ece)
	...
	if obj is None and key == 'stable':
		...
		e = discord.Embed(title="__**Discord.py Documentation Lookup**__", description='[Click to View the Discord.py Documentation](<https://discordpy.readthedocs.io/en/stable>)\nYou may also search for a Reference Point in the Documentation.\n`rtd <Reference Query>`', colour=discord.Colour.blurple(),  timestamp=datetime.now(), color=0xac5ece)
	...
	if obj is None and key == 'python':
		...
		e = discord.Embed(title="__**Python Documentation Lookup**__", description='[Click to View the Python Documentation](<https://docs.python.org/3>)\nYou may also search for a Reference Point in the Documentation.\n`rtd py <Reference Query>`', colour=discord.Colour.blurple(),  timestamp=datetime.now(), color=0xac5ece)
	...
	if len(matches) == 0:
		...
		try:
			...
			embed = discord.Embed(title="__**Lookup Error**__", description="Could not find any Results..", timestamp=datetime.now(), color=0xff0000)
