...
class View(discord.ui.View):
    ...
    def __init__(self, mapping: dict,
        ...
        if ui == 0: self.add_item(Dropdown(ctx=self.ctx, options=self.options))
            ...
            self.linbutton = self.linbutton()
    
    def add_buttons(self):

        self.startB = Buttons(emoji="<:back0:1104722874901745685>",
        ...
        self.backB = Buttons(emoji="<:arrow_left1:1112374617361895454>",
        ...
        self.nextB = Buttons(emoji="<:righttt:1159078379430084669>",
        ...
        self.endB = Buttons(emoji="<:front:1159080140047921173>",
        ...
        self.quitB = Buttons(emoji="<:icons_delete:1159080438854340728>",
    ...
    def linbutton(self):
      ...
      #  self.dt = Button(label="Donate",style=discord.ButtonStyle.link,url="https://discord.gg/JUCyurj7gR")
    ...
    def gen_embeds(self):
        ...
        options.append(
            ...
            discord.SelectOption(label="Home",
                                 ...
                                 emoji='<:home:1112419628795306054>'))
        ...
        for cog in self.get_cogs():
            ...
            if "help_custom" in dir(cog):
                ...
                label, description, current_page = cog.help_custom()

                options.append(discord.SelectOption(label=label))

                embed = discord.Embed(title=f" {label} Commands",

                                      color=0x2f3136)

                embed.set_footer(

                    text=f"Made By Prince",
