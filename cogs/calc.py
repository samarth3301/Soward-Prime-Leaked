...
class lodu(commands.Cog, description="Commands that make your Discord experience nicer!"):
    ...
    @commands.command(help="calculate what you want!", aliases = ['calc1', 'math1', 'maths1'])
    async def calculate1(self, ctx: commands.Context):
...
async def setup(client):
    await client.add_cog(lodu(client))
